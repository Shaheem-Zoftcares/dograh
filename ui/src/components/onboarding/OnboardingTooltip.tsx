...
export const OnboardingTooltip = ({
    ...
    const tooltipContent = (
        ...
        >
            ...
            {/* Tooltip content */}
            <div className="relative bg-primary text-white rounded-lg shadow-2xl p-6 max-w-sm">
                {/* Close button */}
                <button
                    onClick={dismiss}
                    className="absolute top-2 right-2 p-1 hover:bg-[#65101E] rounded-full transition-colors"
                ...
                <div className="flex items-center justify-end gap-3">
                    <button
                        onClick={dismiss}
                        className="bg-white text-primary px-4 py-1.5 rounded font-medium text-sm hover:bg-primary/10 transition-colors cursor-pointer"
                    >
                        Close
                    </button>
                    ...
                    {showNext && (
                        <button
                            ...
                            className="bg-white text-primary px-4 py-1.5 rounded font-medium text-sm hover:bg-primary/10 transition-colors"
                        >
                            Next
                        </button>
                    )}
